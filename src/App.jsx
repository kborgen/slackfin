...
import { parseWallClock, toNOAADateStr, moonPhase, computeRawPoints, DECENT_RAW } from "./scoring";
...
/* ---------------- scoring model ----------------
   The per-point raw math lives in ./scoring.js so the offline
   calibration script can run the identical computation under Node.
   What stays here is the normalization that turns raw into a score.
